...
import { MenuItem, Icon, Modal, ModalHeader, ModalContent, Form, FormField, Input, ModalActions, Button, MenuMenu, Label } from 'semantic-ui-react';
...
class Channels extends React.Component {
  ...
  clearNotifications = () => {
    let index = this.state.notifications.findIndex(n => n.id === this.state.channel.id);
